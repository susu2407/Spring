package kr.co.demo.ch06.controller;

import kr.co.demo.ch06.dto.User1DTO;
import kr.co.demo.ch06.repository.User1Repository;
import kr.co.demo.ch06.service.User1Service.User1Service;
...
public class User1Controller {
    ...
    @PostMapping("/user1/register") // Post이니깐, 아직 ... 수신되는 것 까지만.
    public String register(User1DTO user1DTO){
        log.info(user1DTO.toString());

        service.save(user1DTO);

        return "redirect:/user1/list"; // redirect를 사용하는가? JSP에서부터 사용했다. post를 하고 나면 redirect를 했다.
    }
